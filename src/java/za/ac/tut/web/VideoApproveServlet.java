...
public class VideoApproveServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String text = "<h4> Dear student,<br> Your video, is being approved. <br>Kind regards.<br>   <b>i-TECH Group</b> </h4>";        
        Video video = videoFacade.find(id);
        
        video.setApprove("Approved");
