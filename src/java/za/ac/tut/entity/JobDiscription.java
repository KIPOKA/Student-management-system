 ...
 */
@Entity
public class JobDiscription implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof JobDiscription)) {
            return false;
        }
        JobDiscription other = (JobDiscription) object;
    ...
    public String toString() {
        return "za.ac.tut.entity.JobDiscription[ id=" + id + " ]";
    }
